...
import com.sakurafish.parrot.callconfirm.activity.MainActivity;
...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    public static final String NOTIFICATION_CHANNEL_ID = "parrotcallconfirm_channel_id_01";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        final int lastNo = preference.getInt(Config.PREF_APP_MESSAGE_NO, 0); // 通知済みメッセージ番号
    ...
    private void showNotification(Context context, SharedPreferences preference, int messageNo) {
        ...
        Intent openIntent = MainActivity.createIntent(context, MainActivity.class);
        ...
        editor.putInt(Config.PREF_APP_MESSAGE_NO, messageNo);
        editor.apply();
    }
}
